...
import DataTable from "@/components/Vendedores/datatable";
import ReservationModal from "@/components/Vendedores/ViewDetailsModal";
...
const Reservas = () => {
  ...
  if (role === "provider" && user) {
    ...
    reservationsQuery = query(collection(db, "sellers"));
  }
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="flex justify-between p-4">
        <h2 className="font-semibold text-xl">Vendedores</h2>
      </div>
      <DataTable sellers={reservations} onRowClick={openModal}/>
      {selectedReservation && (
        <ReservationModal
